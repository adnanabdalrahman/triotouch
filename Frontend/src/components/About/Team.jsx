        ...
        <div className="sec-head mb-80">
          <div className="row">
            <div className="col-lg-8">
              <h6 className="sub-title opacity-8 wow fadeInUp mb-15">- Our Team</h6>
          ...
          <div className="col-lg-3 col-md-6">
            <div className="item-join valign">
              <div className="full-width">
                <h5 className="text-u ls2 fw-500">Become Our <br /> Member</h5>
                <a href="/about" className="arrow mt-30">
